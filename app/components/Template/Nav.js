...
const Nav = () => (
  <section id="sidebar">
    <section id="intro">
      ...
      <header>
        <h2>Josip Koncurat</h2>
        <p><a href="mailto:jkoncura@gmail.com">jkoncura@gmail.com</a></p>
      </header>
    </section>
    ...
    <section id="footer">
      ...
      <p className="copyright">&copy; JOSIP KONCURAT <Link to="/">josipkoncurat.com</Link>.</p>
    </section>
  </section>
);
